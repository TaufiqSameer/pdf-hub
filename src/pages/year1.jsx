    ...
    <div className="content-wrapper">
      <div className="left-box">
        ...
        <p>
          ...
          various colleges. If you belong to any of these colleges, please take
          a moment to appreciate their efforts.
        </p>

        <p>
          These materials are provided for reference purposes only. They may not
          be 100% accurate or fully aligned with your university syllabus.
          Students are advised to verify the content before relying on it.
        </p>

        <p>
          If you are a content owner and wish to request the removal of any
          material, please contact me.
        </p>

        <p>
          If you have additional study material that could benefit students,
          feel free to share it at:
          <br />
